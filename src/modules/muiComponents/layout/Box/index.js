      ...
      <AppGridContainer>
        ...
        <Grid item xs={12} md={6}>
          <AppComponentCard
            ...
            noScrollbar
            description='The Box component wraps your component. It creates a new DOM element, a <div> that by default can be changed with the component prop. Lets say you want to use a <span> instead:'
          />
        </Grid>
      </AppGridContainer>
    </>
