      ...
      <AppGridContainer>
        ...
        <Grid item xs={12} md={6}>
          <AppComponentCard
            ...
            noScrollbar
            description='The open state of the component can be controlled with the open/onOpen/onClose props.'
          />
        </Grid>
        <Grid item xs={12} md={6}>
          <AppComponentCard
        ...
        <Grid item xs={12} md={6}>
          <AppComponentCard
            ...
            noScrollbar
            description='The SpeedDialActions tooltips can be displayed persistently so that users dont have to long-press to see the tooltip on touch devices.'
          />
        </Grid>
        <Grid item xs={12} md={6}>
          <AppComponentCard
