...
mock.onPost('/api/scrumboard/add/card').reply((request) => {
  ...
  const selectedBoard = boardData.find((data) => data.id === board.id);
  const selectedList = selectedBoard.list.find((data) => data.id === list.id);
...
mock.onPost('/api/scrumboard/delete/card').reply((request) => {
  ...
  const selectedBoard = boardData.find((data) => data.id === boardId);
  const selectedList = selectedBoard.list.find((data) => data.id === listId);
